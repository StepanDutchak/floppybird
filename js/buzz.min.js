(function (t, n, e) {
    ...
    var t = {
        ...
        sound: function (n, e) {
            ...
            if (
                    ...
                    for (var n = 0; t.length > n; n++)
                        for (var e = t[n], i = e.split('.')[0], u = 0; a.length > u; u++) {
                            ...
                            (a[u].idx == e || (s[1] && s[1] == e.replace('.', ''))) &&
                                (this.sound.removeEventListener(i, a[u].func, !0), a.splice(u, 1));
                        }
                    return this;
                }),
                ...
                e.loop && this.loop(),
                    ...
                    (this.sound.preload = e.preload === !0 ? 'auto' : e.preload === !1 ? 'none' : e.preload),
        ...
        fromTimer: function (t) {
            var n = ('' + t).split(':');
            return (
                n && 3 == n.length && (t = 3600 * parseInt(n[0], 10) + 60 * parseInt(n[1], 10) + parseInt(n[2], 10)),
                n && 2 == n.length && (t = 60 * parseInt(n[0], 10) + parseInt(n[1], 10)),
                t
            );
        },
